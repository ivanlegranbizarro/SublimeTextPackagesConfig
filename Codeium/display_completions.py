...
def make_async_request(req, view):
    global completions, index, for_position, CODEIUM_ENABLED
    if not CODEIUM_ENABLED:
        return
...
class CodeiumToggleCommand(sublime_plugin.ApplicationCommand):
    def run(self):
        ...
        status = "habilitado" if CODEIUM_ENABLED else "deshabilitado"
